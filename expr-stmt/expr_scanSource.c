...
int expr_scan_BeginSourceFileW
# ifdef HAVE_ARGS
   (wchar_t * FileName)
# else
...
void expr_scan_BeginSourceMemory
# ifdef HAVE_ARGS
   (void * InputPtr)
# else
...
# endif
   ...
   expr_scan_BeginSourceMemoryN (InputPtr, length);
}

void expr_scan_BeginSourceMemoryN
# ifdef HAVE_ARGS
...
void expr_scan_BeginSourceGeneric
# ifdef HAVE_ARGS
   (void * InputPtr)
# else
   (InputPtr) void * InputPtr;
