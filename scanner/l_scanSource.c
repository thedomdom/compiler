...
# endif
   ...
   l_scan_BeginSourceMemoryN (InputPtr, length);
}

void l_scan_BeginSourceMemoryN
# ifdef HAVE_ARGS
...
void l_scan_BeginSourceGeneric
# ifdef HAVE_ARGS
   (void * InputPtr)
# else
   (InputPtr) void * InputPtr;
